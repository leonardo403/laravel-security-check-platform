...
<div class="min-h-screen flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-md bg-slate-900/80 border border-slate-700 rounded-2xl shadow-2xl p-8">
        ...
        <form method="POST" action="/reset-password" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium mb-1 text-slate-300">Nova senha</label>
            ...
            <div>
                <label class="block text-sm font-medium mb-1 text-slate-300">Confirmar nova senha</label>
            ...
            <button type="submit" class="w-full rounded-xl bg-cyan-500 py-2.5 font-semibold text-slate-950 hover:bg-cyan-400">Redefinir senha</button>
        </form>
    </div>
</div>
@endsection
